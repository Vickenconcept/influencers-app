...
@endsection
    ...
    <div x-data="{ openModal: false, isContentModal: false, influencer_id: null, influencer_content: null }" class="px-3 pb-20 overflow-y-auto h-screen">
                                    ...
                                    <div class="mx-auto w-[80%]" x-show="emailType == 'default'" x-cloak>
                                        ...
                                        <div class="flex justify-between space-x-3 items-center bg-white p-3  ">
                                            ...
                                            <button wire:click="sendCampaignInvite()" wire:loading.class="opacity-70"
                                                ...
                                                class="@if (json_decode($emails, true) == null) bg-opacity-45 @else @endif bg-blue-600  rounded-lg text-white px-5 py-2 flex items-center space-x-2">
                                                <i class='bx bx-mail-send'></i>
                                                <span wire:loading.target="sendCampaignInvite" wire:loading.remove>Send
                                                    mail</span>
                                                <span wire:loading.target="sendCampaignInvite"
