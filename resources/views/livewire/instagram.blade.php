<div class="px-3 pb-20 overflow-y-auto h-screen" x-data="{ modalIsOpen: false }">
    ...
    <div class="my-6">
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-lg">
            ...
            <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                ...
                {{-- <div class="flex flex-col">
                    <label for="category"
                        class="text-stone-600 text-sm font-medium">category:
                    </label>
                    <input type="text" id="category" class="mt-2 block w-full rounded-md border border-gray-200 px-2 py-2 shadow-sm outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" wire:model="category" placeholder="Enter category">
                </div> --}}
        ...
        <div x-cloak x-show="modalIsOpen" x-transition.opacity.duration.200ms x-trap.inert.noscroll="modalIsOpen"
            ...
            <div x-show="modalIsOpen"
                                    ...
                                    <form class="space-y-4" wire:submit="creatGroup()" method="post">
                                        <div>
                                            ...
                                            <input type="text" name="name" id="name"
                                                wire:model.live="name" class="form-control"
                                        ...
                                        <button type="submit" @click="tab = 'group_tab'"
                                            wire:loading.attr="disabled" wire:target="creatGroup"
                ...
                <div
                    ...
                    <button @click="modalIsOpen = false" type="button"
                        @if (empty($selectedGroups)) disabled @endif wire:click="addToGrop()"
